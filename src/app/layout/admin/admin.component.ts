...
export class AdminComponent implements OnInit, OnDestroy {
  ...
  constructor(public menuItems: MenuItems,
    ...
    this.freamType = 'theme2';
    this.sidebarImg = 'true';
    this.sidebarImgType = 'img4';
    this.layoutType = 'light'; // light(default) dark(dark)

    this.headerTheme = 'theme2'; // theme1(default)
    ...
    this.navBarTheme = 'themelight2'; // themelight1(default) theme1(dark)
    this.activeItemTheme = 'theme2';
    this.pcodedSidebarPosition = 'fixed';
    this.menuTitleTheme = 'theme2'; // theme1(default) theme10(dark)
